 ...
 * @return	    Number of buffers required for the data packet
 */
/// @private
...
/*==============================================*/
/**
 * @brief	    Calculate the length available in the buffers for the message. This is a non-blocking API.
 * @param[in]	global_cb_p  - Pointer to the global control block
 * @param[in]	type		- Type of the socket stream
 * @param[in] buffers		- Available buffers
 * @return	  Length available in the buffers for message
 */
/// @private
