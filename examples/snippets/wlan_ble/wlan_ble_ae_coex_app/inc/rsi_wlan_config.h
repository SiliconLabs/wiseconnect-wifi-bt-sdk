...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                                                               \
  (EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT | EXT_FEAT_SSL_CERT_WITH_4096_KEY_SUPPORT | EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS \
   | MEMORY_CONFIG)
#else
//! To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP                                                                            \
  (RAM_LEVEL_NWP_MEDIUM_MCU_MEDIUM | EXT_FEAT_RSA_KEY_WITH_4096_SUPPORT | EXT_FEAT_SSL_CERT_WITH_4096_KEY_SUPPORT \
...
#else
//! To set wlan feature select bit map
#define RSI_FEATURE_BIT_MAP (FEAT_SECURITY_OPEN | FEAT_ULP_GPIO_BASED_HANDSHAKE | FEAT_DEV_TO_HOST_ULP_GPIO_1)
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP \
  (EXT_TCP_IP_WINDOW_DIV | EXT_TCP_IP_WAIT_FOR_SOCKET_CLOSE) //CONFIG_FEAT_EXTENTION_VALID
