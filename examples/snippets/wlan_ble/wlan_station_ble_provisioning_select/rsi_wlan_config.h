...
#define RSI_TCP_IP_FEATURE_BIT_MAP (TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_TOTAL_SOCKETS_2 | TCP_IP_FEAT_EXTENSION_VALID)
...
#define RSI_EXT_TCPIP_FEATURE_BITMAP (EXT_DYNAMIC_COEX_MEMORY | EXT_TCP_IP_TOTAL_SELECTS_2)
...
#define TCP_RX_HIGH_PERFORMANCE_SOCKETS 2  //@ Total TCP RX High Performance sockets
