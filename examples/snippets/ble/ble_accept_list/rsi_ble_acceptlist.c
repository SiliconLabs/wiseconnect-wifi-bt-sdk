 ...
 */
int32_t rsi_ble_acceptlist(void)
{
  int32_t status         = 0;
...
int main(void)
{
  ...
  //! Call BLE acceptlist application
  status = rsi_ble_acceptlist();
  ...
  rsi_task_create((rsi_task_function_t)(int32_t)rsi_ble_acceptlist,
                  (uint8_t *)"ble_task",
