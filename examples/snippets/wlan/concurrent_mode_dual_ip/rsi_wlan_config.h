...
#define RSI_TCP_IP_FEATURE_BIT_MAP                                                                      \
  (TCP_IP_FEAT_DHCPV4_SERVER | TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DHCPV6_CLIENT | TCP_IP_FEAT_IPV6 \
   | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_DHCPV6_SERVER | TCP_IP_FEAT_SSL)
