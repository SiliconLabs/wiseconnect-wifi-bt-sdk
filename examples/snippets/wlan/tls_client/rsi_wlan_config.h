...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_SSL_VERSIONS_SUPPORT | EXT_FEAT_512K_M4SS_192K
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_SSL_VERSIONS_SUPPORT | EXT_FEAT_704K_M4SS_0K
#endif
#else
