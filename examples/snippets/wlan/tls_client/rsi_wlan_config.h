...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_SSL_VERSIONS_SUPPORT | MEMORY_CONFIG
#else
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP EXT_FEAT_SSL_VERSIONS_SUPPORT | RAM_LEVEL_NWP_ALL_MCU_ZERO
#endif
#else
...
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP \
  (EXT_FEAT_SSL_VERSIONS_SUPPORT | EXT_FEAT_LOW_POWER_MODE | EXT_FEAT_XTAL_CLK_ENABLE | MEMORY_CONFIG)
#else
//! To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP \
