...
- Open the project `<Release_Package>/examples/snippets/wlan/power_save_deep_sleep/projects/power_save_deep_sleep-nucleo-f411re.uvprojx`
...
- Open Simplicity Studio and import the project from `<Release_Package>/examples/snippets/wlan/power_save_deep_sleep/projects`
