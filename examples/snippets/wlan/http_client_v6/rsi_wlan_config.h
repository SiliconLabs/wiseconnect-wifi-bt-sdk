...
#define RSI_TCP_IP_FEATURE_BIT_MAP                                                                              \
  (TCP_IP_FEAT_DHCPV4_CLIENT | TCP_IP_FEAT_DNS_CLIENT | TCP_IP_FEAT_EXTENSION_VALID | TCP_IP_FEAT_DHCPV6_CLIENT \
   | TCP_IP_FEAT_IPV6 | TCP_IP_FEAT_HTTP_CLIENT)

//! To set custom feature select bit map
#define RSI_CUSTOM_FEATURE_BIT_MAP FEAT_CUSTOM_FEAT_EXTENTION_VALID

//! To set Extended custom feature select bit map
#define RSI_EXT_CUSTOM_FEATURE_BIT_MAP (EXT_FEAT_256K_MODE | EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS)
